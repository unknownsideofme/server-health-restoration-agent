...
func main() {
    ...
    setupList := []interface{ SetupWithManager(ctrl.Manager) error }{
        ...
        &controllerspkg.FailureSimulationReconciler{GenericReconciler: controllerspkg.GenericReconciler{ReconcilerBase: controllerspkg.ReconcilerBase{Client: mgr.GetClient(), Scheme: mgr.GetScheme(), Recorder: mgr.GetEventRecorderFor("failuresimulation-controller"), Runtime: runtimeManager}}},
